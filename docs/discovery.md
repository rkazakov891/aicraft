...
The [0.9.0 live recovery report](reports/0.9.0-discovery-live/index.html) records actual Herdr execution, runtime defects and corrections, independent semantic findings, and a staged Spec stopped on two product questions. It is not a full delivery pass.
