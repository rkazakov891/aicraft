...
| --- | --- | --- | --- | --- | --- |
| Project frame | Cast | direct caller, then Spec | [`../../aicraft-cast/SKILL.md#report`](../../aicraft-cast/SKILL.md#report) | OutsideLoop | `ReturnToCaller` |
| Feature or quick contract | Spec | direct caller or Foreman, Review, Land | [`../../aicraft-spec/references/delivery.md#spec-report`](../../aicraft-spec/references/delivery.md#spec-report) | OutsideLoop or Specifying | `ReturnToCaller` or `SpecResult` |
| Task plan | Draft | Foreman, Review | [`../../aicraft-draft/references/plan-contract.md#report`](../../aicraft-draft/references/plan-contract.md#report) | Drafting | `DraftResult` |
| Plan verdict | Review | Foreman, Spec, Draft, Forge, or Land | [`../../aicraft-review/SKILL.md#reports`](../../aicraft-review/SKILL.md#reports) | SpecReview or PlanReview | `PlanVerdict` |
| Task implementation and PR | Forge | Foreman, Review | [`../../aicraft-forge/references/verification-and-handoff.md#forge-report`](../../aicraft-forge/references/verification-and-handoff.md#forge-report) | Implementing | `ForgeResult` |
| Code verdict | Review | Foreman, Forge or Land | [`../../aicraft-review/SKILL.md#reports`](../../aicraft-review/SKILL.md#reports) | CodeReview | `CodeVerdict` |
| Finalization or evidence record | Land | Foreman, Review or direct caller | [`../../aicraft-land/SKILL.md#report`](../../aicraft-land/SKILL.md#report) | SpecLanding, Landing, or FeatureClose | `LandResult` |
| Evidence-sufficiency verdict | Review | Foreman, Land | [`../../aicraft-review/references/evidence-mode.md#evidence-sufficiency-report`](../../aicraft-review/references/evidence-mode.md#evidence-sufficiency-report) | EvidenceReview | `Landing` |
| Retrospective report | Temper | Foreman, Review | [`../../aicraft-temper/SKILL.md#report`](../../aicraft-temper/SKILL.md#report) | Retrospective | `TemperResult` |
| Retrospective verdict | Review | Foreman, Temper | [`../../aicraft-review/SKILL.md#reports`](../../aicraft-review/SKILL.md#reports) | RetroReview | `RetroVerdict` |
