...
Require feature tasks to use `T-XXX`. Validate quick tasks with [`../../aicraft-spec/references/quick.md`](../../aicraft-spec/references/quick.md). Inspect task branches and open PR identities to find in-progress work.
