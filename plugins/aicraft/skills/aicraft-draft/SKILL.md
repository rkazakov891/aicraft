...
4. **Apply MSW.** Invoke `aicraft-msw` after every plan write. Verify the surviving plan still meets the task contract. A decision MSW cannot settle becomes the declared question outcome, not an assumption.
