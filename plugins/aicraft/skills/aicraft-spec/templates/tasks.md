...
<!-- Read tracker.mode from .aicraft/config.yaml. Use exactly one shape throughout.
...
<!-- Keep T-IDs stable. .aicraft/config.yaml owns tracker mode. The paired spec.md owns
