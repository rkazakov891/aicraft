...
2. **User-owned.** A candidate that generalizes beyond this project routes to the user's own prompt artifacts — their global instructions, their own skills — with `aicraft-hone` named as the application step. Propose the change; do not apply it.
