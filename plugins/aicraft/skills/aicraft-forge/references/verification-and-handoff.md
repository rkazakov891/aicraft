...
Route the target to `aicraft-review` or the host loop's fresh reviewer. Forge never invokes itself as reviewer and never treats its own verification as a Review verdict.
